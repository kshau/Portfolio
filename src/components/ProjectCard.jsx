function ProjectCard(props) {
    ...
    return (
        <>
            <a href={href} target="_blank" className="bg-card-bg flex flex-row w-[500px] rounded-[20px] font-bold py-[10px] m-[15px] drop-shadow-lg animate-fadeIn opacity-0 hover:-translate-y-1 hover:scale-105 duration-300" style={{animationDelay: animDelay}}>
